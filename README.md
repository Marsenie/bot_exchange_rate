...
1. Скачать проект
2. Получить токен на сайте [fixer](https://fixer.io/signup/free). Здесь нужно заполнить данные, а здесь находится [токен](https://fixer.io/documentation#apikey)(доступен, после заполнения данных)
